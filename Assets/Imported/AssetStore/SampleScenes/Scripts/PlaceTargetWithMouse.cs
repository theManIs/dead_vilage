...
//            Debug.Log(isHit + " "  + UnityTools.IsPointerOverUI() + " " + hit.collider.gameObject.layer);
            ...
            {
                transform.position = Vector3.Lerp(setTargetOn.transform.position, hit.point + hit.normal * surfaceOffset, 1 - .9f * 2 / Vector3.Distance(setTargetOn.transform.position, hit.point));
