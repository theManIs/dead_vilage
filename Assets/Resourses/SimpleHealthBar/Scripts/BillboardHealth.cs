...
//            Quaternion billbordRot = Quaternion.LookRotation(_camera.transform.position, Vector3.up);
//            billbordRot = Quaternion.Euler(0, billbordRot.eulerAngles.y, billbordRot.eulerAngles.z);
//            transform.rotation = billbordRot;
        }
    }
}
